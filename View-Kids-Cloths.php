<html>
  ...
  $ID = 0;
        ...
        $id = $_GET['view'];
           ...
           $query = "select * from kclothes where id = '$id'";
        ...
        <div class="Details">
          <h1>CHECKOUT</h1>
            ...
            <label class="labelGrp">Buying Qty</label>
              <input class="achr" type="text" name="clothes_Buy_qty"  placeholder="Enter qty">
            </div>
            ...
            <div class="formGrp">
            <div class="formGrp">
              <button class="achr regClass btn" type="Submit" name="Submit">Buy</button>
          ...
          else
          {
            ...
            $query = "UPDATE kclothes SET qty = '$aa' WHERE id = '$id' ";
            ...
            header("refresh:0; url=Kids_cloths.php");

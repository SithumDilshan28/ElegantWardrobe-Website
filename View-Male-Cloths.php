 ...
 ?>
  ...
  $ID = 0;
        ...
        $id = $_GET['view'];
           ...
           $query = "select * from mclothes where id = '$id'";
      ...
      <br>
        <div class="Details">
          <h1>CHECKOUT</h1>
            ...
            <div class="formGrp">
            <label class="labelGrp">Cloth ID</label>
            ...
            <label class="labelGrp">Description</label>
              <input class="achr" type="text" name="Description" value="<?php echo $Discription; ?>"/ required disabled>
            </div>
            <div class="formGrp">
            ...
            <div class="formGrp">
            <label class="labelGrp">Available Quantity</label>
            <input class="achr" type="text" name="clothes_Ava_qty"  placeholder="Enter Quantity" value="<?php echo $qty; ?>" disabled>

            <div class="formGrp">
            <label class="labelGrp">Buying Quantity</label>
              <input class="achr" type="text" name="clothes_Buy_qty"  placeholder="Enter Quantity" required>
            </div>
          ...
          if($b>$qty)
          {
            $msg = "Buying amount is grater than available amount";
          ...
          else
          {
            ...
            $query = "UPDATE mclothes SET qty = '$aa' WHERE id = '$id' ";
            ...
            header("refresh:0; url=male_cloths.php");

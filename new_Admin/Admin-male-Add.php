        ...
        <div class="Details">
          ...
          <form class="regForm" action="#" method="post" enctype="multipart/form-data">
            ...
            <div class="formGrp">
              ...
              <input class="achr" type="text" name="Discription" value="" placeholder="Description" required>
            </div>
            <div class="formGrp">
              <label class="labelGrp">Price</label>
              <input class="achr" type="text" name="Price" value="" placeholder="Price"required>
            </div>
            <div class="formGrp">
            ...
            <div class="formGrp">
              ...
              <input class="achr" type="text" name="Metirial" value="" placeholder="Material" required>
            </div>
            <div class="formGrp">
              <label class="labelGrp">Quantity</label>
              <input class="achr" type="text" name="Qty" value="" placeholder="Quantity" required>
            </div>
            <div class="formGrp">
